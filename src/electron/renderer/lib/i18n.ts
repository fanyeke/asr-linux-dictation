...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    vad_title: "静音检测 (VAD)",
    vad_enable_label: "启用静音自动停止",
    vad_threshold_label: "静音阈值",
    vad_threshold_hint: "越低越灵敏（0.001–0.05）",
    vad_duration_label: "静音持续时间",
    vad_duration_hint: "超过此时长自动停止（500–5000ms）",
    entry_created: "词条已创建",
    entry_updated: "词条已更新",
    entry_deleted: "词条已删除",
  ...
  en: {
    ...
    template_placeholder: "Enter prompt template...",
    ...
    unknown: "Unknown",
    asr_language_label: "ASR Language",
    asr_lang_auto: "Auto Detect",
    asr_lang_zh: "中文",
    asr_lang_en: "English",
    ...
    vad_title: "Silence Detection (VAD)",
    vad_enable_label: "Enable auto-stop on silence",
    vad_threshold_label: "Silence Threshold",
    vad_threshold_hint: "Lower = more sensitive (0.001–0.05)",
    vad_duration_label: "Silence Duration",
    vad_duration_hint: "Auto-stop after this long (500–5000ms)",
